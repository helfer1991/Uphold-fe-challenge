	...
	<FooterStyled>
		<div className="main-footer">
			<div className="footer">
				<UpholdLogo alt="uphold-logo" src="/assets/small-logo.svg" />
				...
				<DropwdownStoresContainer>
					<div className="apps">
						<AppStoresWrapper>
							...
							>
								<img alt="" src="/assets/appstore.svg" />
							</UpholdDetailsAnchor>
							<UpholdDetailsAnchor
								target="_blank"
								rel="noopener noreferrer"
			...
			<aside className="footer-details">
				<div className="uphold-details">
					...
					<nav className="uphold-inc">
						<ul>
							...
							<UpholdDetailsItem>
								<UpholdDetailsAnchor href="/">Agreements</UpholdDetailsAnchor>
							</UpholdDetailsItem>
							<UpholdDetailsItem>
								<UpholdDetailsAnchor href="/">
									Privacy & Data Policy
								</UpholdDetailsAnchor>
							</UpholdDetailsItem>
							<UpholdDetailsItem>
				...
				<img src="/assets/qr-code.svg" alt="uphold-qr-code" />
			</aside>
		</div>
	</FooterStyled>
);
